...
the compact artifact + manifest (CONTRACT 2) and a flat index.json.
    ...
    python -m cclab.pipeline            # all cases
    python -m cclab.pipeline EX02_epidemic --seed 7
"""
...
# data-pipeline/cclab/pipeline.py -> parents[2] = repo root (works under `pip install -e .` too)
