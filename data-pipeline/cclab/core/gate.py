...
so every case passes. The verdict + budgets go into the manifest; CI fails on mislabeling. A MEASUREMENT, never a
hand-wave."""
from __future__ import annotations

LIVE_RUNTIMES: set[str] = {"ts-mill", "onnxruntime-web"}
RUN_MS_GATE = 1500.0
