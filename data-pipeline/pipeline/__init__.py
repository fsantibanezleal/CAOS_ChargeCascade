"""pipeline, the offline+light engine for ChargeCascade (tumbling-mill charge motion + power draw), instantiated on the
...
`--retrain` runs the heavy lane (torch -> ONNX) in pipeline/science/.
"""
