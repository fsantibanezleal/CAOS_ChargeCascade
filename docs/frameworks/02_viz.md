...
| **KaTeX** `^0.16.47` | the Methodology page | the equations, critical speed, the Davis departure + parábola, the regime bands, the power torque-arm, rendered via the shell's `Equation` / `InlineMath`. |
