      ...
      content: (
        <div className="prose">
          <p>{es
            ...
            : 'The 3D mill (Three.js) animates EXACTLY the trajectories the engine computes: each particle rides up with the wall, departs at its Davis angle (cos α = φc²·r/R) and flies a ballistic parábola until it re-impacts at the toe. It is not a decorative animation, it is the engine\'s kinematic solution, rendered. Raise the speed and you watch the cataract fan open; set φc = 1 and the charge pins to the wall (centrifuging).'}{' '}<Cite id="davis1919" paren /></p>
          <p>{es
