  ...
  return (
    <article className="page-body prose">
      ...
      <figure className="cc-fig">
        <svg viewBox="0 0 880 250" width="100%" role="img" aria-labelledby="cc-ov-t cc-ov-d" style={{ display: 'block', fontFamily: 'var(--font-sans, system-ui, sans-serif)' }}>
          ...
          <g className="cc-ov">
            ...
            <text className="s" x="656" y="88">{es ? '(no es un solve DEM)' : '(not a DEM solve)'}</text>
      ...
      <ol>
        ...
        <li>{es ? 'Para cada capa de carga, el ángulo de partida de Davis cos α = φc²·r/R y la parábola de vuelo.' : 'For each charge shell, the Davis departure angle cos α = φc²·r/R and the flight parábola.'}</li>
