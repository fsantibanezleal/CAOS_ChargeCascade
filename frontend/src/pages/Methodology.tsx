        ...
        // ============================================================ SURROGATE (LEARNED)
        {
          ...
          content: (
            <div className="cc-doc-sec">
              ...
              <Equation tex="\varepsilon=\frac{|\hat P-P^{\text{exact}}|}{P^{\text{exact}}}" caption={es ? 'el error relativo del surrogate vs el exacto, mostrado en vivo en la pestaña What-if donde el surrogate es la herramienta' : 'the surrogate\'s relative error vs the exact, shown live on the What-if tab where the surrogate is the tool'} />
