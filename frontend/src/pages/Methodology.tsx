        ...
        // ============================================================ CRITICAL SPEED
        {
          ...
          content: (
            <div className="cc-doc-sec">
              ...
              <Equation tex="\omega = \frac{2\pi}{60}\,\varphi_c N_c,\qquad \text{capa centrifuga}\iff \varphi_c^2\,\frac{r}{R}\ge1\iff r\ge\frac{R}{\varphi_c^2}" caption={es ? 'velocidad angular ω y la condición de centrifugado por capa; a φc = 1 el radio umbral es R (solo la pared)' : 'angular speed ω and the per-shell centrifuging condition; at φc = 1 the threshold radius is R (the wall only)'} />
